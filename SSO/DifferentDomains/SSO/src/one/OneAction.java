...
public class OneAction extends ActionSupport {
    ...
    /**
     * 登录URL
     * http://one.com:8080/sso/doLogin.action
     */
    ...
    public String main() {
        ...
        setGotoUrl("http://one.com:8080/one/main.action");

        //登录URL
        setLoginUrl("http://one.com:8080/one/doLogin.action");
    ...
    public String doLogin() {
        ...
        //校验登录是否成功
        boolean isLogin = Tool.doCheckCookie("http://check.com:8080/sso/doLogin.action", param);
        //当登录成功时
        if (isLogin) {
